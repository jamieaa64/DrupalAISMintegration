# DrupalAISMintegration

A Drupal CMS project created on 2025-11-12 using Claude Code.
...
2. **Clone and start**:
   ```bash
   git clone https://github.com/jamieaa64/DrupalAISMintegration DrupalAISMintegration
   cd DrupalAISMintegration
   ddev start
   ```
